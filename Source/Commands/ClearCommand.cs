...
namespace AdditionalCommands.Commands
{
    public class ClearCommand : CommandBase
    {
        ...
        public static void RemoveForbidden(string user)
        {
            ...
            if(count < Main.mintoremove)
            {
                Messages.Message(user + " Requested a Cleanup. Assuming this was a misshap since there is less than " + Main.mintoremove + " Forbidden Items on the map.", MessageTypeDefOf.SilentInput);
            }
            else
            {
